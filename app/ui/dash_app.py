    ...
    def _build_layout(self) -> None:
        ...
        self.dash_app.layout = dbc.Container(
            [
                ...
                dbc.Tabs(
                    [network_tab, config_sensor_tab, realtime_tab, config_tab, accel_tab],
                    id="tabs",
                    active_tab="network",
                    className="mb-4",
                ),
                ...
                try:
                    ...
                    feedback = dbc.Alert(
                        [
                            ...
                            html.Hr(),
                            html.P("Los datos se están guardando automáticamente en almacenamiento local.", className="mb-0"),
                        ],
                        color="success"
                    )
